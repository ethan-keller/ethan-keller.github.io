...
<div class="intro">
  <img src="/assets/img/pp.png" alt="Ethan Keller">
  <div>
    <h1>Ethan Keller</h1>
    <p>
...
<div class="journey">
  <span>2024 - now</span>
  <img src="/assets/img/logos/amazon.png" alt="">
  <div markdown="span">I joined the AGI team at [Amazon](https://www.amazon.science/) to work on speech generation.</div>

  <span>2022 - 2024</span>
  <img src="/assets/img/logos/imperial.png" alt="">
  <div markdown="1">
...
<script>
mail.onclick = e => (e.preventDefault(), out.textContent = atob(mail.dataset.r).replace('#', '@'));
</script>
